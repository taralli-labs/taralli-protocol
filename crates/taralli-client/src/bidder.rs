...
use taralli_primitives::abi::universal_porchetta::UniversalPorchetta::{ProofOffer, UniversalPorchettaInstance};
...
use taralli_primitives::utils::{compute_offer_id, compute_request_id};
...
where
    ...
    N: Network + Clone,
{
    pub fn new(rpc_provider: P, market_address: Address, min_bid_delay: u64, max_bid_attempts: u32) -> Self {
        Self {
            rpc_provider,
            market_address,
            min_bid_delay,
